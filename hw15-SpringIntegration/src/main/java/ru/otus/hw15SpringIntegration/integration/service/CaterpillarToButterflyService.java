package ru.otus.hw15SpringIntegration.integration.service;
...
@Service
public class CaterpillarToButterflyService {
    ...
    public Butterfly turn(Caterpillar caterpillar) throws Exception {
        ...
        System.out.println();
        System.out.println(caterpillar.shout());
        Thread.sleep(1000);
        System.out.println(
                " ******  ******  ******  ******  ****** \n" +
                        "*  _  _ *      *       *       *        *\n" +
        ...
        System.out.println();
        System.out.println(butterfly.spreedWings());
        return butterfly;
    }
}
